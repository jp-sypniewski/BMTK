...
START TRANSACTION;
USE `bmtkdb`;
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (1, 'adminFirst', 'adminLast', 'admin@admin.com', '12345', NULL, '80111', 'US', '5555555555', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (2, 'ownerFirst', 'ownerLast', 'owner@owner.com', '123456', 'denver', '80111', 'US', '5555555555', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (3, 'empFirst', 'empLast', 'emp@emp.com', '1234567', 'denver', '80237', 'US', '3333333333', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (4, 'userFirst', 'userLast', 'user@user.com', '123', 'denver', '80111', 'US', '2222222222', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (5, 'Mary', 'Sanders', 'marysanders@gmail.com', '5944 round rock street', 'boulder', '80301', 'US', '8546733211', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (6, 'Mark', 'Wayside', 'markwayside@gmail.com', '8711 hay street', 'dallas', '75001', 'US', '8176819021', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (7, 'Bill', 'Jacobs', 'billjacobs@gmail.com', '3498 mill street', 'denver', '80111', 'US', '2543618355', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (8, 'John', 'Pine', 'johnpine@gmail.com', ' 5341 north street', 'denver', '80111', 'US', '6537912333', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (9, 'Ann', 'Good', 'anngood@gmail.com', '7834 bell street', 'denver', '80111', 'US', '9325812312', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (10, 'Sarah', 'Walker', 'sarahwalker@gmail.com', '321 high street', 'denver', '80111', 'US', '6234117553', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (11, 'Gary', 'Newland', 'garynewland@gmail.com', '734 dryer street', 'denver', '80111', 'US', '8745557433', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (12, 'Joe', 'Keppler', 'joekeppler@gmail.com', '632 green street', 'denver', '80111', 'US', '2546719233', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (13, 'Sam', 'Miller', 'sammiller@gmail.com', '7822 hill street', 'denver', '80111', 'US', '6234778211', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (14, 'Diane', 'Weller', 'dianeweller@gmail.com', '7188 bell street', 'denver', '80111', 'US', '6123776399', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (15, 'Matt', 'Simmons', 'mattsimmons@gmail.com', '832 elm street', 'denver', '80111', 'US', '6234517288', 'CO');
INSERT INTO `user_detail` (`id`, `first_name`, `last_name`, `email`, `street`, `city`, `zipcode`, `country`, `phone`, `state`) VALUES (16, 'Harold', 'Mole', 'haroldmole@gmail.com', '8732 copper street', 'denver', '80111', 'US', '9345612544', 'CO');
...
START TRANSACTION;
USE `bmtkdb`;
INSERT INTO `company` (`id`, `name`, `type`, `address`, `phone`, `description`, `company_url`, `active`, `state`) VALUES (1, 'Test Company', 'Construction', '12345 test st', '5554443333', 'test description', 'testcompany.com', 1, 'CO');
INSERT INTO `company` (`id`, `name`, `type`, `address`, `phone`, `description`, `company_url`, `active`, `state`) VALUES (2, 'Bob\'s Plumbing', 'Plumbing', '34 pipe st, Denver, CO,  80014', '8176534591', 'All residential plumbing work from new construction to remodeling to repairs. Free estimates. We supply fixtures. ', 'bobsplumbing.com', 1, 'CO');
INSERT INTO `company` (`id`, `name`, `type`, `address`, `phone`, `description`, `company_url`, `active`, `state`) VALUES (3, 'Fast Action Painting', 'Painting', '571 white street, Dallas, TX, 75001', '6239456789', 'All residential painting, interior or exterior, new construction or remodeling.  Barns, houses, workshops. ', 'fastactionpainting.com', 1, 'CO');
INSERT INTO `company` (`id`, `name`, `type`, `address`, `phone`, `description`, `company_url`, `active`, `state`) VALUES (4, 'County HVAC Service', 'HVAC', '9231 snow street, Alma, CO, 80420', '3256718324', 'Residential and commercial HVAC repair. We install new units. $75 estimate fee is applied towards work order. All of our work is guaranteed. ', 'countyhvac.com', 1, 'CO');
INSERT INTO `company` (`id`, `name`, `type`, `address`, `phone`, `description`, `company_url`, `active`, `state`) VALUES (5, 'Long Valley Surveying', 'Surveying', '7541 west street,  Broomfield , CO 80020 ', '4578934581', 'Land surveys, property lines verified, land subdivided. We can handle all of your surveying needs. ', 'longvalleysurveying.com', 1, 'CO');
INSERT INTO `company` (`id`, `name`, `type`, `address`, `phone`, `description`, `company_url`, `active`, `state`) VALUES (6, 'Hot Switch Electric', 'Electrician', '6324 cherry street, Georgetown, CO, 80444', '9514359111', 'Licensed electricians. Commercial and Residential. Repairs, Remodeling, New Construction. Call to schedule an estimate. ', 'hotswitchelectic.com', 1, 'CO');
INSERT INTO `company` (`id`, `name`, `type`, `address`, `phone`, `description`, `company_url`, `active`, `state`) VALUES (7, 'Uptown Catering', 'Catering', '89324 Hill Street, Boulder, CO,  80301', '5678213733', 'Catering for events, parties, and business meetings. ', 'uptowncatering.com', 1, 'CO');
...
INSERT INTO `project` (`id`, `name`, `customer_id`, `company_id`, `active`, `description`) VALUES (2, 'new bathroom', 2, 1, 1, 'new bath description');
...
INSERT INTO `project` (`id`, `name`, `customer_id`, `company_id`, `active`, `description`) VALUES (8, 'HVAC Repair', 8, 4, 1, 'repair AC');
INSERT INTO `project` (`id`, `name`, `customer_id`, `company_id`, `active`, `description`) VALUES (9, 'Paint bedroom', 9, 3, 1, 'paint bedroom red');
INSERT INTO `project` (`id`, `name`, `customer_id`, `company_id`, `active`, `description`) VALUES (10, 'Basement water leak', 10, 2, 1, 'sump pump failed. please replace.');
INSERT INTO `project` (`id`, `name`, `customer_id`, `company_id`, `active`, `description`) VALUES (11, 'Heater failed', 11, 4, 1, 'please replace heater.');
...
INSERT INTO `project` (`id`, `name`, `customer_id`, `company_id`, `active`, `description`) VALUES (13, 'Paint garage door', 4, 3, 1, 'Paint has started to fade, please repaint garage');
...
START TRANSACTION;
USE `bmtkdb`;
INSERT INTO `task` (`id`, `name`, `description`, `due_date`, `paid`, `created_at`, `updated_at`, `template`, `start_date`, `complete_date`, `status`, `type`, `priority`, `payment_detail`, `price`, `project_id`, `active`) VALUES (1, 'test task', 'task description', '2020-03-01', 0, NULL, NULL, NULL, NULL, NULL, 'ASSIGNED', NULL, 'high', NULL, 1000.00, 1, 1);
INSERT INTO `task` (`id`, `name`, `description`, `due_date`, `paid`, `created_at`, `updated_at`, `template`, `start_date`, `complete_date`, `status`, `type`, `priority`, `payment_detail`, `price`, `project_id`, `active`) VALUES (2, 'bathroom remodel', 'total bathroom remodel. New toilet, sink and shower stall. Location: 654 Beverly Street Denver CO 80111', '2020-03-05', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 50000.00, 2, 1);
INSERT INTO `task` (`id`, `name`, `description`, `due_date`, `paid`, `created_at`, `updated_at`, `template`, `start_date`, `complete_date`, `status`, `type`, `priority`, `payment_detail`, `price`, `project_id`, `active`) VALUES (3, 'paint house exterior', 'Paint all of house exterior. Customer not supplying any materials. Location: 3285 Stone Street Denver CO 80111 ', '2020-03-06', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3500.00, 3, 1);
INSERT INTO `task` (`id`, `name`, `description`, `due_date`, `paid`, `created_at`, `updated_at`, `template`, `start_date`, `complete_date`, `status`, `type`, `priority`, `payment_detail`, `price`, `project_id`, `active`) VALUES (4, 'HVAC unit new compressor', 'Trane Model 588A year 2001 needs new compressor. Location: 544 Hill Street, Denver CO. 80111', '2020-03-02', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 850.00, 4, 1);
INSERT INTO `task` (`id`, `name`, `description`, `due_date`, `paid`, `created_at`, `updated_at`, `template`, `start_date`, `complete_date`, `status`, `type`, `priority`, `payment_detail`, `price`, `project_id`, `active`) VALUES (5, 'subdiving lot', 'residental lot subdivision. 576 gaylord street. 5 acres to be divided into 7 lots. Drawings on location. ', '2020-03-01', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2500.00, 5, 1);
INSERT INTO `task` (`id`, `name`, `description`, `due_date`, `paid`, `created_at`, `updated_at`, `template`, `start_date`, `complete_date`, `status`, `type`, `priority`, `payment_detail`, `price`, `project_id`, `active`) VALUES (6, 'new breaker box', 'Workshop at 5699 elm street needs a larger breaker box so that additional relays may be installed. ', '2020-03-03', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 900.00, 6, 1);
INSERT INTO `task` (`id`, `name`, `description`, `due_date`, `paid`, `created_at`, `updated_at`, `template`, `start_date`, `complete_date`, `status`, `type`, `priority`, `payment_detail`, `price`, `project_id`, `active`) VALUES (7, 'birthday party', 'sweet 16 party. Location: 6500 Grand Plaza suite 400 Denver CO. 25 guests. American food and cake. ', '2020-03-10', 0, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 375.00, 7, 1);
